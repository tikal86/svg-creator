...
public class BlogSvgCreator
{
    ...
    public void shouldCreateBlogDeel1Svg() throws IOException {
        ...
        final Svg svg = new Svg.SvgBuilder(0, 0, 660, 340)
                ...
                .with(new Line.LineBuilder(20,200,600,200, "black").build())
                .with(new Line.LineBuilder(560,185,560,215, "black").build())
                .with(new Polygon.PolygonBuilder(Arrays.asList(new Point(600,190), new Point(630,200), new Point(600,210)),"black","black").build())
                .with(new Circle.CircleBuilder(100, 200, 20, "black", "yellowish").build())
                .with(new Text.TextBuilder(94,207, "2", "small").build())
